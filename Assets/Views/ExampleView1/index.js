(() => {
  ...
  // dist/tsc/Views/ExampleView1/index.js
  var App = () => {
    return createElement("div", { class: "w-full h-full justify-center items-center bg-blue-500 text-white text-2xl" }, "Example View 1");
  };
